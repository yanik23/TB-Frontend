...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// The drawer contains a logout button that navigates the user back to the welcome screen, a settings button and an about button.
      drawer: Drawer(
          child: ListView(
            ...
            onTap: () {
              showDialog(
                ...
                builder: (BuildContext context) => AlertDialog(
                  title: const Text("Settings not implemented yet"),
                  content: const Text("Implementation will follow soon"),
                  actions: [
                    TextButton(
                      child: const Text("OK"),
                      onPressed: () {
          ...
          ListTile(
            ...
            onTap: () {
              showDialog(
                context: context,
                builder: (BuildContext context) => AlertDialog(
                  title: const Text("About The Boka Food App"),
                  content: const Text(
                      "This mobile application was developed by Yanik Lange as part of his bachelor thesis in 2023 at the HEIG-VD. The thesis was supervised by Prof. Raileanu and made in cooperation with the company Boka Food SA."),
                  actions: [
                    TextButton(
                      child: const Text("OK"),
                      onPressed: () {
